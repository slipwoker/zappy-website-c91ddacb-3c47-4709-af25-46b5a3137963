document.addEventListener('DOMContentLoaded', function() {
    ...
    // Initialize any elements already in viewport
    window.addEventListener('load', function() {
        const elementsInView = document.querySelectorAll('.fade-in, .animate-on-scroll');
        elementsInView.forEach(element => {
            const rect = element.getBoundingClientRect();
            if (rect.top < window.innerHeight && rect.bottom > 0) {
                element.classList.add('visible', 'fade-in-visible');
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: 'c91ddacb-3c47-4709-af25-46b5a3137963',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || 'c91ddacb-3c47-4709-af25-46b5a3137963';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = 'c91ddacb-3c47-4709-af25-46b5a3137963';
